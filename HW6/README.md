...
| 26 | `hw6`     | the same as 17<br> `DIM` = 150                                                  | 0.84709       | **0.84909** | 0.8855   | 401       | **Report Problem 1**<br> the best performance                       |
...
| 30 | `hw6`     | the same as 17<br> `DIM` = 300                                                  |               | 0.85250     | 0.7379   | 426       | **Report Problem 1**                                                |
