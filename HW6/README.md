...
| 40 | `hw6`     | seed = 1234<br> `DIM` = 150                               | 1500      | 0.84039       | 0.8851   | 準備要生出大量csv囉(4)                                                            |
| 41 | `hw6`     | seed = 87<br> `DIM` = 140                                 | 1500      | 0.84149       | 0.6783   | 準備要生出大量csv囉(X)                                                            |
| 42 | `hw6`     | `DIM` = 160                                               | 1500      | 0.84071       | 0.6424   | 準備要生出大量csv囉(X)                                                            |
| 43 | `hw6`     | `DIM` = 170                                               | 1500      | 0.84004       | 0.8590   | 準備要生出大量csv囉(X)                                                            |
| 44 | `hw6`     | `DIM` = 148                                               | 1500      | 0.84077       | 0.6629   | 準備要生出大量csv囉(5)                                                            |
| 45 | `hw6`     | `DIM` = 149                                               | 1500      | 0.84058       | 0.6603   | 準備要生出大量csv囉(6)                                                            |
| 46 | `hw6`     | `DIM` = 151                                               | 1500      | 0.84080       | 0.6601   | 準備要生出大量csv囉(7)                                                            |
| 47 | `hw6`     | `DIM` = 150                                               | 1700      | 0.84115       |          | 準備要生出大量csv囉(8)<br> 看來epoch太多就overfit了                               |
| 48 | `hw6`     |                                                           | 1600      | 0.84031       |          | 準備要生出大量csv囉(9)                                                            |
| 49 | `hw6`     |                                                           | 1500      | **0.83997**   |          | 準備要生出大量csv囉(6)                                                            |
...
|  9 | `vote_csv` | `ADD_NUM` = 0.07                                         | 35 36 40 42 43<br> 44 45 46              | **0.83356**   | 看起來`+0.07`的結果不錯                         |
| 10 | `vote_csv` |                                                          | 35 36 40 42 43<br> 44 45 46 47 48        | **0.83353**   |                                                 |
| 11 | `vote_csv` |                                                          | 35 36 40 42 43<br> 44 45 46 48 49        | 0.83364       |                                                 |
...
| 16 | `vote_csv` | 超級大集合 | 6 7 8 9 10<br> 12 13 23 24 26<br> 27 28 29 30 31<br> 32 33 38 39<br> 11 14 15 16 17<br> 18 19 20 21 22<br> 25 34 35 36 37<br> 40 41 42 43 44<br> 45 46 47 48 49 | **0.83396**   |                                                 |
