...
| 42 | `hw6`     | seed = 87<br> `DIM` = 160                                 | 1500      | 0.84071       | 0.6424   | 準備要生出大量csv囉(X)                                                            |
| 43 | `hw6`     | seed = 87<br> `DIM` = 170                                 | 1500      | 0.84004       | 0.8590   | 準備要生出大量csv囉(X)                                                            |
| 44 | `hw6`     | seed = 87<br> `DIM` = 148                                 | 1500      | 0.84077       | 0.6629   | 準備要生出大量csv囉(5)                                                            |
| 45 | `hw6`     | seed = 87<br> `DIM` = 149                                 | 1500      | 0.84058       | 0.6603   | 準備要生出大量csv囉(6)                                                            |
| 46 | `hw6`     | seed = 87<br> `DIM` = 151                                 | 1500      | 0.84080       | 0.6601   | 準備要生出大量csv囉(7)                                                            |
| 47 | `hw6`     | seed = 87<br> `DIM` = 152                                 | 2000      |               |          | 準備要生出大量csv囉(6)                                                            |
