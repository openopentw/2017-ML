...
def choose_data(data):# {{{
    ...
    drop_list = ['id', 'timestamp', 'max_floor', 'material', 'kitch_sq', 'state', 'sub_area', 'full_all', 'male_f', 'female_f',
            'culture_objects_top_25', 'cafe_sum_500_min_price_avg', 'cafe_sum_500_max_price_avg', 'cafe_avg_price_500']
    for s in drop_list:
...
# }}}
# compile & fit# {{{
# model.compile(loss='mean_squared_error', optimizer='adam', metrics=[RMSLE, 'msle'])
