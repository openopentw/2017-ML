...
if CNTL == 1:
    SELECT = np.array([1]+[2]+[3]+[4]+[5] + S_workclass + S_education + S_marital_status + S_occupation + S_relation + S_race + S_native_country)
if CNTL == 2:
    SELECT = np.array([0]+[2]+[3]+[4]+[5] + S_workclass + S_education + S_marital_status + S_occupation + S_relation + S_race + S_native_country)
if CNTL == 3:
    SELECT = np.array([0]+[1]+[3]+[4]+[5] + S_workclass + S_education + S_marital_status + S_occupation + S_relation + S_race + S_native_country)
if CNTL == 4:
    SELECT = np.array([0]+[1]+[2]+[4]+[5] + S_workclass + S_education + S_marital_status + S_occupation + S_relation + S_race + S_native_country)
if CNTL == 5:
    SELECT = np.array([0]+[1]+[2]+[3]+[5] + S_workclass + S_education + S_marital_status + S_occupation + S_relation + S_race + S_native_country)
if CNTL == 6:
    SELECT = np.array([0]+[1]+[2]+[3]+[4]+ S_workclass + S_education + S_marital_status + S_occupation + S_relation + S_race + S_native_country)
if CNTL == 7:
    SELECT = np.array([0]+[1]+[2]+[3]+[4]+[5] + S_education + S_marital_status + S_occupation + S_relation + S_race + S_native_country)
if CNTL == 8:
    SELECT = np.array([0]+[1]+[2]+[3]+[4]+[5] + S_workclass + S_marital_status + S_occupation + S_relation + S_race + S_native_country)
if CNTL == 9:
    SELECT = np.array([0]+[1]+[2]+[3]+[4]+[5] + S_workclass + S_education + S_occupation + S_relation + S_race + S_native_country)
if CNTL == 10:
    SELECT = np.array([0]+[1]+[2]+[3]+[4]+[5] + S_workclass + S_education + S_marital_status + S_relation + S_race + S_native_country)
if CNTL == 11:
    SELECT = np.array([0]+[1]+[2]+[3]+[4]+[5] + S_workclass + S_education + S_marital_status + S_occupation + S_race + S_native_country)
if CNTL == 12:
    SELECT = np.array([0]+[1]+[2]+[3]+[4]+[5] + S_workclass + S_education + S_marital_status + S_occupation + S_relation + S_native_country)
if CNTL == 13:
    SELECT = np.array([0]+[1]+[2]+[3]+[4]+[5] + S_workclass + S_education + S_marital_status + S_occupation + S_relation + S_race)
